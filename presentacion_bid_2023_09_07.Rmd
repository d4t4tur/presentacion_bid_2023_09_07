...
####  Banco Interamericano de Desarrollo, 7 de septiembre de 2023.
<br>
<br>
<br>
<br>
...
### 3.    Proyecto `<data>TUR`
### 4.    Indicadores básicos de turismo provinciales
---
class: inverse center middle
...
knitr::include_graphics("img/dataturimg_home.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/dataturimg_solicitudes.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_rpta.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_reporte.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_reporte2.png")
```
...
### En etapa de testing e importación de datos
]
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_alojamientos.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_altaaloja.png")
```
...
```{r , echo = FALSE, out.height='90%'}
knitr::include_graphics("img/datatur_tablaaloja.png")
```
...
# Indicadores básicos de turismo provinciales (IBTP)

---
# Indicadores básicos de turismo <br>provinciales (IBTP)
...
1) Diagónstico respecto de las estadísticas (institucional, técnico, información, metodología, etc.)

2) Capacitaciones en materia de estadísticas básicas e indicadores asociados
...
1) Relevar información existente

2) Describir "gap de información"

3) Caracterizar RRHH e institucionales existentes

4) Capacitación para apropiación del conocimiento

---

## Productos previstos

1.	Informe N°1: Plan de Trabajo

2.	Informe N°2: Resultado de la Recolección de Información

3.	Informe N°3: Sistematización y Diagnóstico

4.	Informe N°4: Informe Final
...
# CST-A: Principales indicadores


 *  **PIBdt:** Producto interno bruto directo turístico

  
 *  **VABdt:** Valor agregado bruto directo turístico


 *  **VABit:** Valor agregado bruto de las industrias turísticas
...
---
![](img/CST-A-tabla01.png)
---
![](img/CST-A-tabla02.png)
---
![](img/CST-A-tabla03.png)
---
![](img/CST-A-tabla04.png)
---
![](img/CST-A-tabla05.png)
---

class: inverse center middle
# Principales resultados CST-A

---

### PRINCIPALES RESULTADOS SERIE 2004, 2016 A 2019
#### PARTICIPACIÓN DEL TURISMO EN LA ECONOMÍA. PIB Directo turístico
...
### PRINCIPALES RESULTADOS SERIE 2004, 2016 A 2019
#### VALOR AGREGADO BRUTO DIRECTO TURÍSTICO Y DE LAS INDUSTRIAS TURÍSTICAS
<br>
![](img/CST-A-b.png)
...
### PRINCIPALES RESULTADOS SERIE 2004, 2016 A 2019
#### EMPLEO EN LAS INDUSTRIAS TURÍSTICA
<br>
![](img/CST-A-c.png)
---
...
knitr::include_graphics("img/sinta_logo_negro.png")
```
